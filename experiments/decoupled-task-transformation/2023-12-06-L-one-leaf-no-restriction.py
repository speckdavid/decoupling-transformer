...
CONFIGS = []
factorings = {
    'Ls1L' : 'lp(factoring_time_limit=30, strategy=mml, add_cg_sccs=true, min_number_leaves=1)',
}
...
CONFIGS.append(IssueConfig("dec-ls1l-lama-first", [], driver_options=DRIVER_OPTS + ["--alias", "dec-ls1l-lama-first"]))
